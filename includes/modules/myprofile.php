...
if (!$userID) {
    ...
    $data_array = [
        'title' => $_language->module['profile_info'],
    ...
    if (isset($_GET['action']) && $_GET['action'] == "editpwd") {
        ...
        $data_array = [
            'userID' => $userID,
            'edit_password' => $_language->module['edit_password'],
            'old_password' => $_language->module['old_password'],
            'new_password' => $_language->module['new_password'],
            'repeat_new_password' => $_language->module['repeat_new_password'],
            'back' => $_language->module['back'],
            'change_password' => $_language->module['change_password']
        ];
        ...
        $data_array = [
            'userID' => $userID,
            'edit_mail' => $_language->module['edit_mail'],
            'password' => $_language->module['password'],
            'new_email' => $_language->module['new_email'],
            'repeat_new_email' => $_language->module['repeat_new_email'],
            'back' => $_language->module['back'],
            'change_mail' => $_language->module['change_mail']
        ];
	    ...
	    $data_array = [
            'userID' => $userID,
            'del_realy' => $_language->module['del_realy'],
            'password' => $_language->module['password'],
            'back' => $_language->module['back'],
            'del_acc' => $_language->module['del_acc']
        ];
    ...
    $hash = $CAPCLASS->getHash();
        ...
        $data_array = [
            ...
            'game_selection' => $_language->module['game_selection'],
            'profile_info' => $_language->module['profile_info'],
            'nick_name' => $_language->module['nickname'],
            'edit_password' => $_language->module['edit_password'],
            'edit_mail' => $_language->module['edit_mail'],
            'del_acc' => $_language->module['del_acc'],
            'delete' => $_language->module['delete'],
            'or' => $_language->module['or'],
            'signature' => $_language->module['signature'],
            'lang_avatar' => $_language->module['avatar'],
            'lang_userpic' => $_language->module['userpic'],
            'personal_info' => $_language->module['personal_info'],
            'first_name' => $_language->module['first_name'],
            'last_name' => $_language->module['last_name'],
            'lang_town' => $_language->module['town'],
            'date_of_birth' => $_language->module['date_of_birth'],
            'lang_gender' => $_language->module['gender'],
            'home_page' => $_language->module['homepage'],
            'about_myself' => $_language->module['about_myself'],
            'options' => $_language->module['options'],
            'language' => $_language->module['language'],
            'mail_on_new_pm' => $_language->module['mail_on_new_pm'],
            'hide_e-mail' => $_language->module['hide_e-mail'],
            'formatdate' => $_language->module['format_date'],
            'formattime' => $_language->module['format_time'],
            'social_media' => $_language->module['social_media'],
            'media_twitch' => $_language->module['twitch'],
            'media_youtube' => $_language->module['youtube'],
            'media_twitter' => $_language->module['twitter'],
            'media_instagram' => $_language->module['instagram'],
            'media_facebook' => $_language->module['facebook'],
            'media_steam' => $_language->module['steam'],
            'fields_star_required' => $_language->module['fields_star_required'],
            'update_profile' => $_language->module['update_profile'],
            'lang_you_have_to_nickname' => $_language->module['you_have_to_nickname'],
            'lang_you_have_to_firstname' => $_language->module['you_have_to_firstname'],
            'lang_you_have_to_bday' => $_language->module['you_have_to_bday'],
            'lang_hint' => $_language->module['hint'],
            ...
            'profilevisibility' => $_language->module['profile_visibility']
        ];

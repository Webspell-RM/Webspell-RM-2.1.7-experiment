...
// Plugin-Manager und Sprachdateien laden
...
// Definiere, welche Seite standardmäßig angezeigt wird
$getsite = 'startpage'; # Wird auf der Startseite angezeigt index.php
if (isset($qs_arr['site'])) {
    $getsite = $qs_arr['site'];
}

// Holen der Erweiterungseinstellungen aus der Datenbank
$ergebnis = safe_query("SELECT * FROM " . PREFIX . "settings_expansion WHERE active = '1'");
$ds = mysqli_fetch_array($ergebnis);

echo '<!-- ======= Navigation ======= -->';

echo '<header id="header" class="sticky-top d-flex align-items-center">
        <div class="container d-flex justify-content-between">
            <div class="logo">
                <!-- Logo anzeigen -->
                <a href="#">
                    <img class="img-fluid" src="../includes/expansion/' . $ds['pfad'] . '/images/' . $ds['logo_pic'] . '" alt="Logo">
                </a>
            </div>
            <div class="box">
                <!-- Text anzeigen -->

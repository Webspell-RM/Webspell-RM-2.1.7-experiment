...
/*// mysqli Verbindung anlegen    Beispiel Nutzung
...
// LanguageManager instanzieren
$langManager = new LanguageManager($mysqli);

// Neue Sprache hinzufügen
$success = $langManager->insertLanguage([
    'iso_639_1'   => 'de',
    'iso_639_2'   => 'deu',
    'name_en'     => 'German',
    'name_native' => 'Deutsch',
...
if ($success) {
    echo "Sprache erfolgreich eingefügt.";
} else {
    echo "Fehler beim Einfügen der Sprache.";
}
*/
...
$language_array = array(
    "tooltip_1" => "Dies ist die URL der Seite, z.B. (https://deinedomain.de). Mit http:// oder https:// am Anfang und nicht mit Slash enden!",
    ...
    "tooltip_55" => "Tragen Sie hier die URL zum API Host Server ein. Standard: https://api.webspell.org",
    ...
    "captcha-text" => "Hier handelt es sich um die alte Captcha-Abfrage. Sie ist nicht mehr so sicher gegen Bots und Co. Bitte verwendet die neue Google reCaptcha Abfrage!",
    "captcha" => "Captcha",
